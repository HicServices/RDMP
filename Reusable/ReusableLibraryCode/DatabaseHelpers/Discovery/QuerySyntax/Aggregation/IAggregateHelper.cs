...
namespace ReusableLibraryCode.DatabaseHelpers.Discovery.QuerySyntax.Aggregation
{
    ...
    /// 
    /// Because building a dynamic pivot / calendar table for a group by is so different in each DatabaseType the input is basically just a collection of strings
    ...
    /// just by concatenating the CustomLines.
    /// </summary>
