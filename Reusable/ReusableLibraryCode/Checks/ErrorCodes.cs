...
public static class ErrorCodes
{
    ...
    public static readonly ErrorCode ExtractionInformationMissing = new("R014", "The following columns no longer map to an ExtractionInformation(it may have been deleted){0}", CheckResult.Warning);
