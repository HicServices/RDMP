...
namespace Dashboard.CatalogueSummary.DataQualityReporting.SubComponents
{
    ...
    /// column is a single categorical field in the dataset that is the most useful way of slicing the dataset e.g. Healthboard (See CatalogueCollection).  If your dataset has a pivot column
    /// then this control will let you change which results are displayed in the TimePeriodicityChart, ColumnStatesChart and RowStatePieChart from either All rows in the dataset or only 
