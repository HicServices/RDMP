...
{
    /// <summary>
    ///     The default number of seconds to allow queries to run for when no value or an invalid value is specified by the
    ///     user
    /// </summary>
    ...
    private readonly Button _btnRunOrCancel;

    /// <summary>
    ///     The original SQL this control was launched with
    /// </summary>
    private readonly string _orignalSql;
    ...
    private readonly Tab queryTab;
    private readonly Tab resultTab;
    private readonly TableView tableView;
    protected TabView TabView;
    private readonly SqlTextView textView;
    ...
    private void TbTimeout_TextChanged(ustring value)
    {
