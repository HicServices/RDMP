...
public partial class ConsoleGuiRunPipeline : Window, IPipelineRunner, IDataLoadEventListener, IListDataSource
{
    ...
    private readonly Pipeline[] _compatiblePipelines;
    ...
    private readonly HashSet<IDataLoadEventListener> additionals = new();

    private GracefulCancellationTokenSource cancellation;
    private int? exitCode;

    private readonly List<NotifyEventArgs> notifyEventArgs = new();
    private readonly DataTable progressDataTable;
