...
public class TestsRequiringADle : TestsRequiringA
{
    ...
    protected override void SetUp()
    {
        ...
        LiveTable.CreatePrimaryKey(LiveTable.DiscoverColumn("chi"), LiveTable.DiscoverColumn("dtCreated"),
    ...
    /// <summary>
    ///     Creates a <see cref="AnySeparatorFileAttacher" /> parcelled into a <see cref="ProcessTask" /> that reads CSV files
    ///     in ForLoading
    ...
    /// <summary>
    ///     Creates a new demography file ready for loading in the ForLoading directory of the load with the specified number
    ///     of <paramref name="rows" />
    /// </summary>
    ...
    /// <summary>
    ///     Creates a new file in the ForLoading directory of the <see cref="LoadDirectory" /> with the specified
