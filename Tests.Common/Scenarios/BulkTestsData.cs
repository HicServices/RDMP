...
/// <summary>
///     Class for creating a large table of data in a test Microsoft Sql Server database and importing a reference to it as
///     a <see cref="Catalogue" />
/// </summary>
public class BulkTestsData
{
    ...
    private readonly Demography _dataGenerator;

    /// <summary>
    ///     Rdmp reference to the test table (<see cref="ImportAsCatalogue" />).  <see cref="Catalogue" /> is the descriptive
    ///     element while <see cref="tableInfo" /> is the
    ///     pointer to the underlying table.
    /// </summary>
    public ICatalogue catalogue;

    /// <summary>
    ///     Rdmp reference to the test table columns (<see cref="ImportAsCatalogue" />).  <see cref="CatalogueItem" /> is the
    ///     descriptive element while <see cref="columnInfos" /> is the
    ...
    /// <summary>
    ///     Prepares to create a new table in the <paramref name="targetDatabase" /> of test data using
    ///     <see cref="Demography" />. To actually generate the data
    ...
    /// <summary>
    ///     Creates the <see cref="BulkDataTable" /> in the <see cref="BulkDataDatabase" /> and uploads test data.  Use
    ///     <see cref="ImportAsCatalogue" /> to get
    ...
    /// <summary>
    ///     Creates Rdmp metadata objects (<see cref="catalogue" />, <see cref="tableInfo" /> etc) which point to the
    ///     <see cref="BulkDataTable" />
    /// </summary>
    /// <returns></returns>
