namespace CatalogueLibrary.DataFlowPipeline
{
    ...
    /// 
    /// <para>e.g. typical functionality might include resetting recordsRead to 0, refreshing a DataTable from the remote server, rebuilding internal schemas etc.</para>
    /// </summary>
