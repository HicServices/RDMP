...
namespace CatalogueLibrary.Data.Dashboarding
{
    ...
    /// 
    /// A good example of an IObjectCollectionControl (which are driven by IPersistableObjectCollection) is CohortSummaryAggregateGraph which requires both a graph and a cohort
