...
{
    /// <summary>
    /// Describes a period of time in which a given act can take place (e.g. only cache data from the MRI imaging web service during
    /// the hours of 11pm - 5am so as not to disrupt routine hospital use).
    /// </summary>
