...
namespace CatalogueLibrary.Data
{
    ...
    public interface IFilter : ICollectSqlParameters, INamed,IHasQuerySyntaxHelper,ICheckable
    {
        ...
        /// 
        /// <para>This results in the filter being added to <see cref="CatalogueLibrary.Data.Cohort.CohortIdentificationConfiguration"/> , extarctions etc by default when the <see cref="Catalogue"/> is added</para>
        /// </summary>
