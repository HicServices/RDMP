...
namespace CatalogueManager.Validation
{
    ...
    /// 
    /// Because regular expressions can get pretty complicated both a concept name and a verbose description that explains what the pattern matches and what it won't match.  You can also 
