...
namespace CatalogueManager.Validation
{
    ...
    /// </summary>
    public partial class ResolveMissingTargetPropertiesForm : Form
    {
        string[] AvailableColumns { get; set; }
        
        public ResolveMissingTargetPropertiesForm( Validator validator, ExtractionInformation[] availableColumns)
        {
        ...
        public static IEnumerable<ItemValidator> GetMissingReferences(Validator v, IEnumerable<ExtractionInformation> columns)
        {
