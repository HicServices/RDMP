...
public class AtomicCommandFactory : CommandFactoryBase
{
    ...
    public IEnumerable<IAtomicCommand> CreateCommands(object o)
    {
        ...
        //EntityFramework.Models.CohortIdentificationConfiguration cic = null;
        //if (Is(o, out EntityFramework.Models.DataExport.ProjectCohortIdentificationConfigurationAssociation pcic) || Is(o, out cic))
        //{
        ...
        //          Weight = -99.8f
        //      }.SetTarget(cic);
        //        if (pcic != null) commit.SetTarget((DatabaseObject)pcic.Project);
