...
namespace Rdmp.Core.CommandExecution
{
    ...
    /// <see cref="CatalogueFolder"/>.  But you could equally turn it into an <see cref="ExecuteCommandAddCatalogueToCohortIdentificationSetContainer"/> (also an ICommandExecution) by combining it with a CohortAggregateContainer.
    /// 
