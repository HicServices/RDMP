...
{
    /// <summary>
    /// A potentially executable object.  Can be translated into an ICommandExecution by an ICommandExecutionFactory.  For example ICommand CatalogueCombineable can 
