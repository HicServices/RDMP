...
public sealed class ExecuteCommandCloneExtractionConfiguration : BasicCommandExecution
{
    ...
    public override void Execute()
    {
        ...
        foreach (var ds in _toRemove.Cast<ExtractableDataSet>()) clone.RemoveDatasetFromConfiguration(ds);
        foreach (var c in _toAdd)
        {
            //check if the eds already exists
