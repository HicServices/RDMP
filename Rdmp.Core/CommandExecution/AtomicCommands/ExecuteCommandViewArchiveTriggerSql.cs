...
/// </summary>
public class ExecuteCommandViewArchiveTriggerSql : ExecuteCommandViewDataBase, IAtomicCommandWithTarget
{
    private IExtractionConfiguration _extractionConfiguration;
    private ISelectedDataSets _selectedDataSet;

    [UseWithObjectConstructor]
    public ExecuteCommandViewArchiveTriggerSql(IBasicActivateItems activator,
    ...
    public ExecuteCommandViewArchiveTriggerSql(IBasicActivateItems activator) : base(activator, null)
    {
    }

    public override string GetCommandHelp() =>
        "Shows the SQL Structure that will be executed to create the archive trigger for the given dataset";
    ...
    protected override IViewSQLAndResultsCollection GetCollection()
    {
        ...
        return _selectedDataSet == null
            ? null
            : (IViewSQLAndResultsCollection)new ViewSelectedDatasetArchiveTriggerUICollection(sds);
    }
