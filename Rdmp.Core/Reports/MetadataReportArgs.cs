...
public class MetadataReportArgs
{
    ...
    /// <summary>
    /// True to generate a count of the distinct values in the <see cref="ConcreteColumn.IsExtractionIdentifier"/> column (if any) in the table under the <see cref="Catalogues"/>
    /// </summary>
    ...
    /// <summary>
    /// True to output data about <see cref="CatalogueItem"/> which are marked <see cref="ExtractionCategory.Deprecated"/>
    /// </summary>
