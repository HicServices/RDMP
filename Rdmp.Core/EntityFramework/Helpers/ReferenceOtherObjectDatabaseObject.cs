...
/// </summary>
public abstract class ReferenceOtherObjectDatabaseObject: DatabaseObject, IReferenceOtherObjectWithPersist
{
    ...
    /// <inheritdoc/>
    protected ReferenceOtherObjectDatabaseObject() : base()
    {
    }

    ///// <inheritdoc/>
    //protected ReferenceOtherObjectDatabaseObject(RDMPDbContext catalogueDbContext, DbDataReader r) : base(catalogueDbContext, r)
    //{
