...
/// <summary>
///     For use with classes who intend to be constructed by <see cref="PickAnyConstructorJsonConverter" />.  If you
///     implement this interface then the callback notify you after your
