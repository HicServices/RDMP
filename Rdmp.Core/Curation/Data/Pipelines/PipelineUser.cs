...
/// <summary>
///     Helper for standardising access to properties on a class which reference a Pipeline.  Because many classes
///     reference Pipelines and some reference multiple Pipelines
///     we use this class to abstract that away.  For example the CacheProgress constructor says to use "Pipeline_ID" int
///     property.
...
public class PipelineUser : IPipelineUser
{
    ...
    /// <summary>
    ///     The object which references a <see cref="Pipeline" /> for which you want the user to be able to change selected
    ///     instance.
    /// </summary>
    public DatabaseEntity User { get; }
    ...
    /// <summary>
    ///     Declares that the given <paramref name="property" /> (which must be nullable int) stores the ID (or null) of a
    ///     <see cref="Pipeline" /> declared
