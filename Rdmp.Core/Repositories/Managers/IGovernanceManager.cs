...
///     <see cref="ICatalogue" /> datasets are governed by which <see cref="GovernancePeriod" /> (many to many
///     relationship)
/// </summary>
public interface IGovernanceManager
{
    ...
    /// <summary>
    ///     Returns the IDs of all <see cref="GovernancePeriod" /> with the corresponding set of <see cref="Catalogue" /> IDs
    ///     which are covered by the governance.
    /// </summary>
    /// <returns></returns>
