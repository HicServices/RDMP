...
public class DQEPostLoadRunner : IMutilateDataTables
{
    ...
    public ExitCodeType Mutilate(IDataLoadJob job)
    {
        ...
        foreach (var link in linkage)
        {
            ...
            var runner = RunnerFactory.CreateRunner(new ThrowImmediatelyActivator(job.RepositoryLocator.CatalogueDbContext, job.RepositoryLocator.DataExportDbContext), options);
