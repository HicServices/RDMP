...
/// <summary>
/// Calculates the changes that occurred during a given DLE execution (identified by the unique DataLoadRunID of the load).  This involves generating and running SELECT
