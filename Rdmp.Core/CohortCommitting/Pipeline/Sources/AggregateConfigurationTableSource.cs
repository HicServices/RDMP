    ...
    IPipelineRequirement<EntityFramework.Models.AggregateConfiguration>
{
    ...
    protected virtual string GetSQL()
    {
        ...
        var cohortBuilder = new CohortQueryBuilder(AggregateConfiguration, cic.GetAllParameters());
    ...
    public virtual void PreInitialize(IBasicActivateItems activator, EntityFramework.Models.AggregateConfiguration value, IDataLoadEventListener listener)
    {
