...
public class PatientIndexTableSource : AggregateConfigurationTableSource, IPipelineRequirement<EntityFramework.Models.DataExport.ExtractableCohort>
{
    ...
    public void PreInitialize(IBasicActivateItems activator, EntityFramework.Models.DataExport.ExtractableCohort value, IDataLoadEventListener listener)
    {
        _extractableCohort = value;
    }

    public override void PreInitialize(IBasicActivateItems activator, EntityFramework.Models.AggregateConfiguration value, IDataLoadEventListener listener)
    {
