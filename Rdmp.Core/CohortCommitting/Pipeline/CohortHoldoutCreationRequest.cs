...
/// </summary>
public sealed class CohortHoldoutCreationRequest : PipelineUseCase, ICanBeSummarised,ICohortHoldoutCreationRequest
{
    ...
    public CohortHoldoutCreationRequest(CohortIdentificationConfiguration cic, string name,int count, bool isPercent, string descriptionForAuditLog)
    {
    ...
    public void Check(ICheckNotifier notifier)
    {
        ...
        //        $"Project {Project} does not have a ProjectNumber specified, it should have the same number as the CohortHoldoutCreationRequest ({NewCohortDefinition.ProjectNumber})",
        //        CheckResult.Fail));
        //else if (Project.ProjectNumber != NewCohortDefinition.ProjectNumber)
        //    notifier.OnCheckPerformed(
        //        new CheckEventArgs(
        //            $"Project {Project} has ProjectNumber={Project.ProjectNumber} but the CohortHoldoutCreationRequest.ProjectNumber is {NewCohortDefinition.ProjectNumber}",
        //            CheckResult.Fail));
    ...
    //    if (NewCohortDefinition.ID == null)
    //        throw new NotSupportedException(
    //            "CohortHoldoutCreationRequest cannot be imported because its ID is null, it is likely that it has not been pushed to the server yet");
    ...
    /// Design time types
    /// </summary>
    private CohortHoldoutCreationRequest() : base(new Type[]
    {
    ...
    public static PipelineUseCase DesignTime() => new CohortHoldoutCreationRequest();
