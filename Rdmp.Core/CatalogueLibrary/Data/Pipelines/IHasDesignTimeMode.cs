...
namespace Rdmp.Core.CatalogueLibrary.Data.Pipelines
{
    ...
    /// 
    /// <para>PipelineComponents should check objects they are initialized with (See <see cref=" CatalogueLibrary.DataFlowPipeline.Requirements.IPipelineRequirement{T}"/>)
