...
/// <summary>
/// Describes the role of an <see cref="AggregateConfiguration"/> being cached by a
...
{
    /// <summary>
    /// The <see cref="AggregateConfiguration"/> is a set of identifiers used for building a cohort
    ...
    /// <summary>
    /// The <see cref="AggregateConfiguration"/> is a graph / summary table useful for visualizing the
    /// data referenced by a <see cref="Catalogue"/>.  The cached table may be displayed on a web page or used for
    ...
    /// <summary>
    /// The <see cref="AggregateConfiguration"/> is a patient index table that contains a list of
