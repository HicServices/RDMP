...
/// <summary>
///     Describes the use case in which a <see cref="Pipeline" /> takes artifacts produced as part of one or more
///     <see cref="ExtractionConfiguration" /> for a <see cref="Project" />.
///     The artifacts may be CSV files, tables in an extraction database etc.  The artifacts should be gathered and sent to
