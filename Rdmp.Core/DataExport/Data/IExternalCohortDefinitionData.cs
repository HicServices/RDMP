...
{
    /// <summary>
    /// The <see cref="IProject.ProjectNumber"/> stored in the remote definition table for this cohort.  This restricts which
    ...
    /// <summary>
    /// The externally held version number for the cohort.  When combined with <see cref="ExternalDescription"/> allows you to
