...
{
    public static readonly ErrorCode ExistingExtractionTableInDatabase = new ErrorCode("R001",
    ...
    public static readonly ErrorCode ExtractTimeoutChecking =
        new ErrorCode("R002", "Failed to read rows after {0}s", CheckResult.Warning);
    public static readonly ErrorCode ExtractionProgressColumnProbablyNotADate = new ErrorCode("R003",
        "Data type for column '{0}' is '{1}' which is not a date.  If the SelectSQL is a transform to then this is ok",
        CheckResult.Warning);
    public static readonly ErrorCode ExtractionIsIdentifiable = new ErrorCode("R004",
    ...
    public static readonly ErrorCode ExtractionContainsSpecialApprovalRequired = new ErrorCode("R005",
        "ExtractionConfiguration '{0}' dataset '{1}' contains SpecialApprovalRequired columns: {2}",
        CheckResult.Warning);
    public static readonly ErrorCode ExtractionContainsInternal = new ErrorCode("R006",
        "ExtractionConfiguration '{0}' dataset '{1}' contains Internal columns: {2}", CheckResult.Warning);
    public static readonly ErrorCode ExtractionContainsDeprecated = new ErrorCode("R007",
    ...
    public static readonly ErrorCode CouldNotLoadDll =
        new ErrorCode("R008", "Encountered Bad Assembly loading {0} into memory", CheckResult.Success);
    public static readonly ErrorCode CouldOnlyHalfLoadDll =
        new ErrorCode("R009", "Loaded {0}/{1} Types from {2}", CheckResult.Warning);
    public static readonly ErrorCode CohortAndExtractableDatasetsAreOnDifferentServers = new ErrorCode("R010",
        "Cohort is on server '{0}' ({1}) but dataset '{2}' is on '{3}' ({4})", CheckResult.Warning);
    public static readonly ErrorCode CouldNotReachCohort = new ErrorCode("R011",
    ...
    public static readonly ErrorCode ExtractionFailedToExecuteTop1 =
        new ErrorCode("R012", "Failed to execute Top 1 on dataset '{0}'", CheckResult.Warning);
    public static readonly ErrorCode TextColumnsInExtraction = new ErrorCode("R013",
    ...
    public static readonly ErrorCode ExtractionInformationMissing = new ErrorCode("R014",
        "The following columns no longer map to an ExtractionInformation(it may have been deleted){0}",
        CheckResult.Warning);

    public static readonly ErrorCode AttemptToReleaseUnfinishedExtractionProgress = new ErrorCode("R015",
        "Dataset {0} should not be released because its ExtractionProgress has a progress date of {1} but an end date of {2}",
        CheckResult.Fail);
    public static readonly ErrorCode NoSqlAuditedForExtractionProgress = new ErrorCode("R0016",
        ...
        CheckResult.Fail);
    public static readonly ErrorCode CohortSwappedMidExtraction = new ErrorCode("R0017",
    ...
    /// </summary>
    public static readonly List<ErrorCode> KnownCodes = new List<ErrorCode>();
