...
public class UITests : UnitTests
{
    ...
    /// <summary>
    ///     Generates the <see cref="ItemActivator" /> (if it hasn't already been initialized).  This is normally done
    ///     automatically
    ...
    /// <summary>
    ///     'Launches' a new instance of the UI defined by Type T which must be compatible with the provided
    ///     <paramref name="o" />.  The UI will not
    ///     visibly appear but will be mounted on a Form and generally should behave like live ones.
    ///     <para>
    ///         Method only tracks one set of results at once, so if you call this method more than once then expect old
    ///         Errors to disapear.
    ///     </para>
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="o"></param>
    /// <param name="setDatabaseObject">
    ///     True to call <see cref="IRDMPSingleDatabaseObjectControl.SetDatabaseObject" /> before returning.  If false you
    ...
    ///     <see cref="LastUserInterfaceLaunched" />)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    ...
    /// <summary>
    ///     Triggers a refresh message for the given <paramref name="o" />.  This will update any user interfaces displaying
    ///     it.
    /// </summary>
    /// <param name="o"></param>
    ...
    ///     <see cref="CatalogueUI" /> for <see cref="Catalogue" />.  Then calls the <paramref name="action" /> on the ui
    ///     instance
    ///     created.
    /// </summary>
