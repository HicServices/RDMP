...
public class ExplicitDatabaseNameChecker
{
    public static void FindProblems(List<string> csFilesFound)
    {
        ...
        var ignoreList = new List<string>
        {
            ...
            "ExecuteCrossServerDatasetExtractionSourceTest.cs", //allowed as it has a dump of generated SQL
            "CloneExtractionConfigurationTests.cs" //allowed as it has a dump of generated SQL
        };
