...
public class RunUITests:DatabaseTests
{
    ...
    public void AllCommandsCompatible()
    {
        ...
        Console.WriteLine(
            $"The following commands are supported:{Environment.NewLine}{string.Join(Environment.NewLine, supported.Select(cmd => cmd.Name))}");
    ...
    {
        public TestCommand_LotsOfParameters(IRDMPPlatformRepositoryServiceLocator repositoryLocator, DiscoveredDatabase databaseToCreateInto, DirectoryInfo projectDirectory)
        {
    ...
    {
        public TestCommand_TypeParameter(IRDMPPlatformRepositoryServiceLocator repositoryLocator, Type myType)
        {
