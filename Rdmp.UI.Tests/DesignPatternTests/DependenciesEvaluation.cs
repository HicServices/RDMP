...
{
    private readonly string[] _nuspecFiles =
    {
    ...
    private readonly Dictionary<string, string> Dependencies = new();
    ...
    ///     The version required, can include 0 elements for wildcards e.g. 11.0.0.0 would be
    ///     compatible with 11.2.0.0
    /// </param>
    /// <returns></returns>
