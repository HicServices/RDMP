    ...
    public static void FindProblems()
    {
        var problems =
            MEF.GetAllTypes()
                ...
                .Where(static matchingInterface => matchingInterface != null && !Exemptions.Contains(matchingInterface.Name) && !typeof(IMapsDirectlyToDatabaseTable).IsAssignableFrom(matchingInterface))
