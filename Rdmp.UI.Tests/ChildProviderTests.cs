...
internal class ChildProviderTests : UITests
{
    ...
    public void TestUpTo()
    {
        string[] skip =
        {
            ...
            "_oProjectNumberToCohortsDictionary", "_errorsCheckNotifier", "ProgressStopwatch","CohortIdentificationConfigurationRootFolderWithoutVersionedConfigurations","_changeTracking", "_lastSeenVersion"
        };
