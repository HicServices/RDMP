...
{
    public FloatWindow CreateFloatWindow(DockPanel dockPanel, DockPane pane) => new CustomFloatWindow(dockPanel, pane);

    public FloatWindow CreateFloatWindow(DockPanel dockPanel, DockPane pane, Rectangle bounds) =>
        new CustomFloatWindow(dockPanel, pane, bounds);
}