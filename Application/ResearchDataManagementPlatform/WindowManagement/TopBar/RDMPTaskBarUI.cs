...
public partial class RDMPTaskBarUI : UserControl
{
    ...
    /// <summary>
    ///     Updates the enabled status (greyed out) of the Forward/Back buttons based on the current <see cref="_manager" />
    ///     <see cref="NavigationTrack{T}" />
    /// </summary>
    ...
    private void AddNewLayout()
    {
        ...
        var dialog = new TypeTextOrCancelDialog("Layout Name", "Name", 100);
