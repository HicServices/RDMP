...
public class ExecuteCommandCreateDatasetTests : CommandCliTests
{
    ...
    public void TestDatasetCreationOKExtendedParameters()
    {
        ...
        Assert.DoesNotThrow(cmd.Execute);
        var founddataset = GetMockActivator().RepositoryLocator.CatalogueDbContext.GetAllObjects<Core.Curation.Data.Dataset>().First(static ds => ds.Name == "dataset2" && ds.DigitalObjectIdentifier == "somedoi" && ds.Source == "some source");
