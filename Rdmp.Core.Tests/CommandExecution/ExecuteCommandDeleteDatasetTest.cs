...
namespace Rdmp.Core.Tests.CommandExecution
{
    internal class ExecuteCommandDeleteDatasetTest: CommandCliTests
    {
        ...
        public void TestDeleteExistingDataset()
        {
            ...
            Assert.That(GetMockActivator().RepositoryLocator.CatalogueRepository.GetAllObjects<Rdmp.Core.Curation.Data.Dataset>().Length,Is.EqualTo(1));
            ...
            Assert.That(GetMockActivator().RepositoryLocator.CatalogueRepository.GetAllObjects<Rdmp.Core.Curation.Data.Dataset>().Length, Is.EqualTo(0));
        }
