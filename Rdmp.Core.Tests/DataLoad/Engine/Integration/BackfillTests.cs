...
{
    public string GetDatabaseName(string rootDatabaseName, LoadBubble convention) => rootDatabaseName;

    public string GetName(string tableName, LoadBubble convention) => tableName;

    public static bool IsNamedCorrectly(string tableName, LoadBubble convention) => true;
}