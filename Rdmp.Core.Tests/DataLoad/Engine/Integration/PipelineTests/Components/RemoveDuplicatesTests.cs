...
public class RemoveDuplicatesTests
{
    ...
    {
        Assert.AreEqual(0,new RemoveDuplicates().ProcessPipelineData(new DataTable(),ThrowImmediatelyDataLoadEventListener.Quiet,new GracefulCancellationToken()).Rows.Count);
    }
    ...
    public void TestMultipleBatches()
    {
        ...
        Assert.AreEqual(1,remover.ProcessPipelineData(dt, ThrowImmediatelyDataLoadEventListener.Quiet, new GracefulCancellationToken()).Rows.Count);
        ...
        Assert.AreEqual(1, remover.ProcessPipelineData(dt2, ThrowImmediatelyDataLoadEventListener.Quiet, new GracefulCancellationToken()).Rows.Count);
    }
    ...
    public void TestNulls()
    {
        ...
        Assert.AreEqual(5, remover.ProcessPipelineData(dt, ThrowImmediatelyDataLoadEventListener.Quiet, new GracefulCancellationToken()).Rows.Count);
