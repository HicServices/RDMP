...
public class ImportAndTestTests : DatabaseTests
{
    ...
    public void ImportFunctionIntoCatalogue()
    {
        ...
        Assert.That(_function.TableInfoCreated.Name.Contains("MyAwesomeFunction(@startNumber,@stopNumber,@name)"));
    }
    ...
    public void TestDiscovery()
    {
        ...
        Assert.That(cols[0].GetFullyQualifiedName().Contains("MyAwesomeFunction.[Number]"));
        Assert.That(cols[1].GetFullyQualifiedName().Contains("MyAwesomeFunction.[Name]"));
    ...
    public void Synchronization_ExtraParameter()
    {
        ...
        //no changes yet
        Assert.That(excessParameter.HasLocalChanges().Evaluation == ChangeDescription.NoChanges);
        ...
        Assert.That(excessParameter.HasLocalChanges().Evaluation == ChangeDescription.DatabaseCopyWasDeleted);
    }
    ...
    public void Synchronization_ParameterDefinitionChanged()
    {
        ...
        Assert.That(parameter.HasLocalChanges().Evaluation == ChangeDescription.NoChanges);
        ...
        Assert.That(parameter.HasLocalChanges().Evaluation == ChangeDescription.DatabaseCopyDifferent);
