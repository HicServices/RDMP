...
public class AggregateFilterPublishingTests:CohortIdentificationTests
{
    ...
    public void NotPopulated_ParameterNoComment()
    {
        ...
        var importedFilter = new FilterImporter(new ExtractionFilterFactory(_chiExtractionInformation), null).ImportFilter(null, _filter, null);
    ...
    public void ShortcutFiltersWork_ProperlyReplicatesParentAndHasFK()
    {
        ...
        _=new AggregateDimension(CatalogueRepository,testData.extractionInformations.Single(e => e.GetRuntimeName().Equals("sex")), shortcutAggregate);
