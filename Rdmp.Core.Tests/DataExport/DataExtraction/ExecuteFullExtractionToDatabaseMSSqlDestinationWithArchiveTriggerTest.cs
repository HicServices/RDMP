...
public class ExecuteFullExtractionToDatabaseMSSqlDestinationWithArchiveTriggerTest : DatabaseTests
{
    ...
    //add a column
    [Test]
    public void SQLServerDestinationWithTriggersAddAColumn()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
    ...
    //remove a column
    [Test]
    public void SQLServerDestinationWithTriggersRemoveAColumn()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
    ...
    [Test]
    public void SQLServerDestinationWithTriggersRemoveAColumnAddAColumn()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
    ...
    [Test]
    public void SQLServerDestinationWithTriggersRemoveAColumnAddItBack()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
    ...
    [Test]
    public void SQLServerDestinationWithTriggersAddAColumnThenRemoveADifferentOne()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
        ...
        Assert.That(archiveTable.Exists());
        archive_dt = archiveTable.GetDataTable();
        Assert.That(archive_dt.Rows, Has.Count.EqualTo(3));
        Assert.That(archive_dt.Columns, Has.Count.EqualTo(43));
    }
    //add a column, remove the same column 
    [Test]
    public void SQLServerDestinationWithTriggersAddAColumnThenRemoveTheSameOne()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
    ...
    [Test]
    public void SQLServerDestinationWithTriggersAddAColumnAndRemoveAtSameTime()
    {
        var db = GetCleanedServer(DatabaseType.MicrosoftSQLServer);
