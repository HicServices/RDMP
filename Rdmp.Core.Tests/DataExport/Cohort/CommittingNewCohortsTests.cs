...
namespace Rdmp.Core.Tests.DataExport.Cohort
{
    public class CommittingNewCohortsTests : TestsRequiringACohort
    {
        ...
        public void CommittingNewCohortFile_IDPopulated_Throws()
        {
            ...
            CohortCreationRequest request = new CohortCreationRequest(proj, new CohortDefinition(511, "CommittingNewCohorts",1,999,_externalCohortTable), new ThrowImmediatelyActivator(RepositoryLocator), "fish");
        ...
        public void CommittingNewCohortFile_ProjectNumberNumberMissing()
        {
            ...
            CohortCreationRequest request = new CohortCreationRequest(proj, new CohortDefinition(null, "CommittingNewCohorts", 1, 999, _externalCohortTable), new ThrowImmediatelyActivator(RepositoryLocator), "fish");
            var ex = Assert.Throws<Exception>(()=>request.Check(new ThrowImmediatelyCheckNotifier()));
        ...
        public void DeprecateOldCohort(bool deprecate)
        {
            ...
            CohortCreationRequest request1 = new CohortCreationRequest(proj, definition998, new ThrowImmediatelyActivator(RepositoryLocator), "fish");
            ...
            CohortCreationRequest request2 = new CohortCreationRequest(proj, definition999, new ThrowImmediatelyActivator(RepositoryLocator), "fish");
