...
- When cloning an ExtractionConfiguration with a depricated catalogue, the GUI will ask if you want to replace the depricated catalogue with the known replacement
