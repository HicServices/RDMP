...
namespace Rdmp.UI.ScintillaHelper
{
    ...
    public class ScintillaTextEditorFactory
    {
        ...
        private void SetSQLHighlighting(Scintilla scintilla, IQuerySyntaxHelper syntaxHelper)
        {
            ...
            string word2 =
                @"ascii cast char charindex ceiling coalesce collate contains convert current_date current_time current_timestamp current_user dateadd datediff floor getdate isnull max min nullif object_id session_user substring system_user tsequal upper";
