...
/// <summary>
///     Allows you to create an arrangement of IDashboardableControls on a Form that is stored in the Catalogue database
///     and viewable by all RDMP users.  Use the task bar at the top of the
///     screen to add new controls.  Then click the spanner to drag and resize them.  Each control may also have some
///     flexibility in how it is configured which is accessible in edit mode.
/// </summary>
