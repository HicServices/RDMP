...
///     <para>
///         Used throughout the RDMP software to inform the user about the progress or checking of an activity.  Messages
///         will appear along with a result (Success,Fail,Warning) and optionally
///         an Exception if one was generated.  Double clicking a message lets you view a StackTrace and even view the
///         source code (See ViewSourceCodeDialog) where the message was generated
...
public partial class ChecksUI : UserControl, ICheckNotifier
{
    ...
    private readonly ConcurrentBag<CheckEventArgs> _results = new();
    private readonly Bitmap _tick;

    private readonly Timer _timer;
    private readonly Bitmap _warning;
    private readonly Bitmap _warningEx;

    private readonly object olockYesNoToAll = new();
