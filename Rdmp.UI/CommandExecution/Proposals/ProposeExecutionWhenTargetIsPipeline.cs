...
namespace Rdmp.UI.CommandExecution.Proposals
{
    class ProposeExecutionWhenTargetIsPipeline : RDMPCommandExecutionProposal<Pipeline>
    {
        ...
        public override void Activate(Pipeline target)
        {
            ...
            {
                TaskDescription = $"The Pipeline '{target}' is not compatible with any known Pipeline use cases.  Select which use case you want to edit it under (which activity best describes what how the Pipeline is supposed to be used?).",
