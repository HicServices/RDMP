...
/// <summary>
/// Determines whether drag and drop operations are legal or not.  The legality and action of a given drop is modeled by <see cref="Rdmp.Core.CommandExecution.ICommandExecution"/>
/// </summary>
public interface ICommandExecutionFactory
{
    /// <summary>
    /// Creates an ICommandExecution which reflects the combining of the two objects (<see cref="ICombineToMakeCommand"/> can even reflect a collection).  If no possible combination of the two objects is possible
