...
/// <summary>
///     Only visible after running the Data Quality Engine at least once on a given dataset (Catalogue).  Shows the number
///     of records each month in the dataset that are passing/failing
///     validation as a stack chart.  The Data tab will show you the raw counts that power the graph.  See
///     SecondaryConstraintUI for validation configuration and ConsequenceKey for the
