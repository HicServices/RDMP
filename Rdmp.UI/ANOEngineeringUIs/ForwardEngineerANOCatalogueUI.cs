...
/// <summary>
///     Allows you to create an anonymous version of a Catalogue by selecting which columns to anonymise and which to drop
///     etc.  This will create a new table in the
///     database of your choice which will be imported as a new Catalogue and a new LoadMetadata will be created that will
///     migrate and apply the anonymisations to the
...
public partial class ForwardEngineerANOCatalogueUI : ForwardEngineerANOCatalogueUI_Design
{
    ...
    public ForwardEngineerANOCatalogueUI()
    {
        ...
        olvNumberOfCharacters.AspectGetter = o =>
            o is ANOTable table ? table.NumberOfCharactersToUseInAnonymousRepresentation : null;
        olvNumberOfDigits.AspectGetter =
            o => o is ANOTable table ? table.NumberOfIntegersToUseInAnonymousRepresentation : null;
