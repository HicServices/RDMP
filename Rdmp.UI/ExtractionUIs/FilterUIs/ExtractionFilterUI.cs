...
///         withdrawn consent' and implmenetation SQL of 'MyTable.IActive=1'. Make
///         sure to fully specify the names of columns in your WHERE SQL incase the filter is used as part of a join across
///         multiple tables with columns that contain the same name (e.g. it might
...
public partial class ExtractionFilterUI : ExtractionFilterUI_Design, ILifetimeSubscriber, ISaveableUI
{
    ...
    public override void SetDatabaseObject(IActivateItems activator, ConcreteFilter databaseObject)
    {
        ...
        CommonFunctionality.AddToMenu(new ExecuteCommandViewFilterMatchData(Activator, databaseObject));
