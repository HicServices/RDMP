...
/// <summary>
///     Part of ParameterCollectionUI, this control shows the SQL generated by the current configuration of SQL parameters.
///     You can edit the SQL in areas that do not have a grey background
///     (these reflect locked parameters - see ParameterCollectionUI).  editing the SQL changes the corresponding SQL
///     parameter in ParameterCollectionUI.  You cannot add new Parameters by
///     directly typing in new SQL or change the line number of in the control (basically you should stick to editing the
///     name/declaration and the value text.
/// </summary>
public partial class ParameterEditorScintillaControlUI : RDMPUserControl
{
    private readonly Scintilla QueryEditor;

    private readonly List<ParameterEditorScintillaSection> Sections = new();
