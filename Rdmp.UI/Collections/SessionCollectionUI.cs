...
/// <summary>
///     Toolbox control for storing user defined collections of objects.  Similar to <see cref="FavouritesCollectionUI" />
///     but for limited lifetime scope.  Note that this class inherits from <see cref="RDMPUserControl" /> not
///     <see cref="RDMPCollectionUI" />
/// </summary>
public class SessionCollectionUI : RDMPUserControl, IObjectCollectionControl, IConsultableBeforeClosing
{
    private bool _firstTime = true;
    private OLVColumn olvName;
    private TreeListView olvTree;
