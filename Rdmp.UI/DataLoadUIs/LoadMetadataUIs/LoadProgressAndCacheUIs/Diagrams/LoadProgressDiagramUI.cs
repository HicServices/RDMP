...
public partial class LoadProgressDiagramUI : RDMPUserControl
{
    ...
    private ChartLookAndFeelSetter _chartLookAndFeelSetter = new ChartLookAndFeelSetter();
    ...
    private void olvDQERuns_ButtonClick(object sender, BrightIdeasSoftware.CellClickEventArgs e)
    {
