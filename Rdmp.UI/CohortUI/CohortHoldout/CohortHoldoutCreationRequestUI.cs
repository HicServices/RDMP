...
/// </summary>
public partial class CohortHoldoutCreationRequestUI : RDMPForm
{
    ...
    public CohortHoldoutCreationRequestUI(IActivateItems activator, IExternalCohortTable target, IProject project = null, CohortIdentificationConfiguration cic = null) :
        base(activator)
    {
        _target = target;
    ...
    public CohortHoldoutCreationRequest Result { get; set; }
