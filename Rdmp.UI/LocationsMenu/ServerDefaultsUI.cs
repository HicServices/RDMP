...
/// <summary>
///     The RDMP Data Catalogue database is the central resource for storing all information about what is where, what
///     datasets there are, what servers they are on etc.  This includes
///     keeping track of the locations of other servers such as the Logging server/database, Data Quality Engine reporting
///     database, anonymisation databases, query caching databases
///     etc.
///     <para>
///         This dialog lets you set which server references (ExternalDatabaseServer) are used for each of the defaults
///         that RDMP has (e.g. which logging server should be used by default)
///     </para>
/// </summary>
