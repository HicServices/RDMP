...
/// <summary>
///     Central component class for handling all low level RDMP main user interface systems. This includes things like Tree
///     object child provision, Icon provision,
///     the publish system for notifying out of date objects etc.  Each function is segregated by a component class
///     property e.g. RefreshBus, FavouritesProvider etc
...
public interface IActivateItems : IBasicActivateItems
{
    ...
    /// <summary>
    ///     Component for closing and opening multiple windows at once for optimal user experience for achieving a given task
    ///     (e.g. running a data load)
    /// </summary>
    ...
    /// <summary>
    ///     Launches a new instance of the specified RDMPSingleDatabaseObjectControl Type with the supplied DatabaseEntity.  If
    ///     you already have
    ...
    /// <summary>
    ///     Shows the <paramref name="form" />.  This method exists so tests can suppress the behaviour and to facilitate
    ///     standardisation
    /// </summary>
    ...
    /// <summary>
    ///     Determines system behaviour when an object is found to be out of sync with the remote database.  Typically
    ///     implementing
    ...
    /// <param name="initialSearch">
    ///     The value to set the search textbox to on load if objects are being selected during this
    ///     operation, or null.
    /// </param>
