...
{        
    ...
    {
        Add(args.Masquerader is CohortSourceUsedByProjectNode projectOnlyNode
            ? new ExecuteCommandShowSummaryOfCohorts(_activator, projectOnlyNode) { Weight = -99.9f }
            : new ExecuteCommandShowSummaryOfCohorts(_activator, externalCohortTable) { Weight = -99.9f });
    }
}