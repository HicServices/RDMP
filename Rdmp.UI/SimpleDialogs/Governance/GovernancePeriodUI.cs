...
///     provider.  This control lets you configure a period of governance (GovernancePeriod) which can be open ended (never
///     expires).  You must then choose which datasets (Catalogues)
///     the governance permission applies to.  Finally you can attach documents that prove the permission (See
///     GovernanceDocumentUI).
///     <para>
///         You should make sure you name and describe the governance period.  The name should correspond to the period.
///         For example you might have 3 periods 'Fife approvals 2001-2002',
///         'Fife approvals 2002-2003' and 'Fife open ended approvals 2003-Forever'.
///     </para>
///     <para>
///         If you are doing yearly approvals you can import the dataset list from the last year as the basis of
///         governanced datasets.
///     </para>
///     <para>
///         If a GovernancePeriod expires all datasets (Catalogues) in the period will be assumed to have expired
///         governance and will appear in the Dashboard as expired unless there is a new
///         GovernancePeriod that is active.
///     </para>
/// </summary>
