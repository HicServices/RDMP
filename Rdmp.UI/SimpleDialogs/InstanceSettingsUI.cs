...
namespace Rdmp.UI.SimpleDialogs
{
    public partial class InstanceSettingsUI : RDMPForm
    {
        ...
        {
            var userSetUpdateURL = _activator.RepositoryLocator.CatalogueDbContext.GetAllObjects<Setting>().FirstOrDefault(static s => s.Key == "UserSetUpdateURL");
            ...
            {
                var newSetting = new Setting(_activator.RepositoryLocator.CatalogueDbContext, "UserSetUpdateURL", tbCustomUpdateURL.Text);
