...
public class NavigationTrack<T>
{
    ...
    /// </summary>
    /// <param name="aliveDelegate">
    ///     Delegate for pruning dead items from the stack (e.g. closed forms).  Return true if your
    ///     <typeparamref name="T" /> should survive filter.
    /// </param>
    ...
    /// <summary>
    ///     Called when changes are detected, includes Clear, Append etc. Does not include <see cref="Prune" /> which is often
    ///     called as part of internal operations.
    /// </summary>
    public event EventHandler Changed;

    /// <summary>
    ///     Removes all dead objects in the history (forward and backwards).  This is based on the alive delegate used to
    ///     construct the <see cref="NavigationTrack{T}" />
    /// </summary>
    public void Prune()
    {
    ...
    /// <summary>
    ///     Calls <see cref="Back(bool)" /> <paramref name="i" /> times.  If this results in a valid <see cref="Current" />
    ///     then the activate delegate will be triggered
    /// </summary>
    /// <param name="i"></param>
    ...
    /// <summary>
    ///     Returns true if the current state is an exploration of the past history and therefore the user can navigate
    ///     Forwards again
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    ///     Returns x history objects that <see cref="Back(bool)" /> would go to if called.  This does not affect the state of
    ///     the history.  Result does not include <see cref="Current" />
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    ///     Changes the behaviour of <see cref="Append" /> to do nothing, use this if you want to activate something or load a
    ///     layout without populating the history / affecting the current history.
    /// </summary>
    public void Suspend()
    {
        _suspended = true;
