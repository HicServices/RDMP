...
/// <summary>
///     Allows you to view and execute an SQL query generated by RDMP, this could be a preview of the top 100 records of a
///     TableInfo or an extract from an Aggregate Configuration graph
///     The purpose is to give you a quick view as to the content of the table/column without having to launch 'Sql
///     Management Studio' or whatever other tool you use to query your data
///     repository.  You can edit the SQL as you need but only a single DataTable return is supported, this form is not a
///     replacement for an SQL IDE.
...
public partial class ViewSQLAndResultsWithDataGridUI : RDMPUserControl, IObjectCollectionControl
{
    ...
    private readonly ToolStripLabel _serverHeader;
    private Task _task;
    private readonly ToolStripButton btnExecuteSql = new("Run");
    private readonly ToolStripButton btnResetSql = new("Restore Original SQL");
