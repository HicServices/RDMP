...
/// <summary>
///     Main component control of ConfigurePipelineUI (See ConfigurePipelineUI for details).  Shows you all compatible
///     components on the left including any plugin components.  Components in
///     red are not compatible with the current context for example a DelimitedFlatFileDataFlowSource requires a
///     FlatFileToLoad and is therefore incompatible under any context where that object is
///     not available.
/// </summary>
public partial class PipelineWorkAreaUI : UserControl
{
    ...
    private readonly List<AdvertisedPipelineComponentTypeUnderContext> _allComponents;
    private readonly ArgumentCollectionUI _arumentsCollection1;
    private IPipeline _pipeline;
    private readonly PipelineDiagramUI _pipelineDiagram;
