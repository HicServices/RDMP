...
/// 
/// <para>But in the case of this control the Type is not user editable but will be populated (hopefully) by the RDMP automatically e.g. CatalogueDbContext.  In this case this control
