...
/// <summary>
///     TECHNICAL: Allows you as a C# programmer to generate RDMP code automatically to help you build plugins and
///     particularly plugin ITableRepository databases more efficiently.
/// </summary>
public partial class GenerateClassCodeFromTableUI : Form
{
    private readonly Scintilla _codeEditor;
